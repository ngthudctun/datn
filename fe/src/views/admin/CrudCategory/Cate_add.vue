          ...
          <div class="px-lg-2" style="box-sizing: border-box">
            ...
            <div class="mt-4" style="border-top: 1px solid #e1e1e1">
              <div class="w-100 d-flex flex-wrap">
                <div class="col-12 col-lg-8" style="border-right: 1px solid #e1e1e1">
                  <div class="p-2" style="box-sizing: border-box">
                    <div class="form-group mt-3">
                      <label for="usr" class="d-flex">Tên danh mục:
                        <div v-if="erroraray && erroraray['category_name']" class="text-danger mx-2">
                          {{ erroraray["category_name"][0] }}
                        </div>
                      </label>
                      <input v-model="category_name" value="máy tính" placeholder="nhập tên danh mục" type="text"
                        class="mt-1 form-control" id="usr" style="box-shadow: 0 0 2px rgba(0, 0, 0, 0.5)" />
                    </div>

                    <div class="form-group mt-3 position-relative">
                      <label for="usr" class="d-flex">Danh mục cha: </label>
                      <form class="d-flex form-control mt-1 align-items-center position-relative" for="myInputcate"
                        style="box-shadow: 0 0 2px rgba(0, 0, 0, 0.5)">
                        <input placeholder="VD: Máy tính-Máy tính bảng-laptop" autocomplete="off"
                          class="m-0 p-0 w-100 border-0" type="text" id="myInputcate" v-on:click="
                      ...
                      <ul id="myULcate" class="position-absolute my-ul-list top-100 w-100"
                        style="left: 0; overflow-y: auto">
                        <li v-for="(item, index) in category_parent_arr" :key="index">
                          <div href="#" class="box-con w-100">
                            <label class="w-100" :for="'idcate-' + item.id">
                              <input type="radio" class="list_cate" name="category_product" :id="'idcate-' + item.id"
                                :value="item.category_name" v-on:click="Adminlayout.clickout('myULcate')"
                      ...
                      <div class="d-flex flex-wrap">
                        <div v-if="category_parent_name != null" class="me-2 p-1 rounded d-flex align-items-center"
                          style="background-color: #e1e1e1">
                          <i v-on:click="deletecateselect()" class="fa-solid fa-trash px-2 link-secondary"
                            style="border-right: 1px solid"></i>
                    ...
                    <div class="form-group mt-3">
                      ...
                      <select v-model="status" name="" class="form-control mt-1" id="">
                    ...
                    <div class="collapse mt-3" id="collapseExamplevari">
                      <h6 class="d-flex">
                        <div class="cursor-pointer link-danger" @click="variantcontroll.upstepvariant(1)" href="">
                          Thêm thuộc tính
                        </div>
                      </h6>
                    </div>
                ...
                <div class="col-12 col-lg-4">
                  <div class="p-2" style="box-sizing: border-box">
                    <div class="form-group mt-3">
                      ...
                      <input v-model="slug" value="may-tinh" autocomplete="off" placeholder="VD: may-tinh" type="text"
                        class="mt-1 form-control" id="usr" style="box-shadow: 0 0 2px rgba(0, 0, 0, 0.5)" />
                    </div>

                    <div class="form-group mt-3 position-relative">
                      <label for="usr">Hình ảnh danh mục</label><br />
                      <dragimg type="categories" classify="variantpro" inputshowimg="imageindex" hideninp="lableindex"
                        @returnimg="reimg" />
                      <input type="hidden" id="" name="selected_image" />
                    </div>
                  </div>
                  <div class="w-100">
                    <button type="button" @click="uploadcate()" class="w-100 btn btn-danger">
                      Thêm danh mục
                    </button>
                  </div>
                </div>
