                          ...
                          >
                            <div class="">
                              <div class="text-start">
                                ...
                                <br />
                                <select
                                  v-on:change="getselectop($event.target.value)"
                                  class="form-select"
                                  id="categorySelect"
                                >
                                  <option value="">Tất cả</option>
                                  <option value="option-1">Danh mục</option>
                                  <option value="option-2">Mức giá</option>
                                  <option value="option-3">Người bán</option>
                                </select>
                                <br />
